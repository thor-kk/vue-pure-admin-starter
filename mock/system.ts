...
export default defineFakeRoute([
      ...
      if (body.id == 1) {
        return {
          ...
          data: [
            ...
            304, 305, 400, 401, 402, 403, 404, 500, 501, 502, 503, 600, 701, 702
          ]
        }
      } else if (body.id == 2) {
        return {
  ...
  // 字典管理-根据字典 dictId 查字典详情
  {
    ...
    response: ({ body }) => {
      ...
      const filteredList =
        body.dictId && [100, 200, 300, 400].includes(body.dictId) ? list.filter((v) => v.dictId === body.dictId) : []
    ...
    response: ({ body }) => {
      let list = [
        ...
        },
        {
          ...
          status: 1,
          remark: 'https://gitee.com/dymproject/purest-admin/tree/main/client-vue',
          createTime: 1635561000000
        }
      ]
      list = list.filter((item) => item.name.includes(body?.name))
    ...
    response: ({ body }) => {
      if (body.id == 101) {
        return {
          ...
          data: [
            100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 200, 201, 202, 203, 204, 205, 300, 301, 302, 303,
            304, 305, 400, 401, 402, 403, 404, 500, 501, 502, 503
          ]
        }
      } else if (body.id == 102) {
        return {
