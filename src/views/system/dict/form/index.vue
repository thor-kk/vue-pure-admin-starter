...
const predefineColors = ref(['#6abe39', '#e84749', '#9fceff', '#fab6b6', '#172412', '#274a17', '#2b1316', '#58191c'])
      ...
      <re-col>
        <el-form-item label="标签颜色">
          <el-input v-model="newFormInline.color" class="color-input" clearable placeholder="请输入或选择标签颜色">
            <template #append>
              <el-color-picker v-model="newFormInline.color" :predefine="predefineColors" />
            </template>
          </el-input>
        </el-form-item>
      </re-col>
