declare module 'vue' {
  ...
  export interface GlobalComponents {
    IconifyIconOffline: (typeof import('../src/components/pure/ReIcon'))['IconifyIconOffline']
    IconifyIconOnline: (typeof import('../src/components/pure/ReIcon'))['IconifyIconOnline']
    FontIcon: (typeof import('../src/components/pure/ReIcon'))['FontIcon']
    Auth: (typeof import('../src/components/pure/ReAuth'))['Auth']
    Perms: (typeof import('../src/components/pure/RePerms'))['Perms']
  }
}
